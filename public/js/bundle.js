...
exports.forgotPassword = exports.logout = exports.signup = exports.login = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, username, email, password) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully created your account');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            (0, _alerts.showAlert)('error', 'Error sending request, please try again');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"search.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/recipes/search/".concat(searchTerm)
            });
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              location.assign("/search/".concat(searchTerm));
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error searching, please try again');
...
var menuIcon = document.querySelector(".nav-mobile-button");
var menuIconHamburger = document.querySelector(".nav-mobile-button-menu");
var menuIconClose = document.querySelector(".nav-mobile-button-x");
var menuContent = document.querySelector(".nav-menu__mobile");
var menuCollapsible = document.querySelectorAll(".nav-mobile__link-collapse");
var desktopSearchForm = document.getElementById("desktopSearchForm");
var mobileSearchForm = document.getElementById("mobileSearchForm");
var loginForm = document.querySelector(".auth-form-login");
var signupForm = document.querySelector(".auth-form-signup");
var forgotPasswordForm = document.querySelector(".auth-form-forgotpassword");
var logoutButton = document.querySelectorAll(".button-logout"); // Mobile Menu Delegation
...
if (desktopSearchForm) {
  desktopSearchForm.addEventListener("submit", function (event) {
    ...
    var searchTerm = document.getElementById("desktopSearchInput").value;
    (0, _search.search)(searchTerm);
  });
}
...
if (mobileSearchForm) {
  mobileSearchForm.addEventListener("submit", function (event) {
    event.preventDefault();
    var searchTerm = document.getElementById("mobileSearchInput").value;
    (0, _search.search)(searchTerm);
  });
}
...
if (signupForm) {
  signupForm.addEventListener("submit", function (event) {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value;
    (0, _auth.signup)(name, username, email, password);
  });
}
...
if (menuCollapsible) {
  menuCollapsible.forEach(function (button) {
...
var reviewsButton = document.querySelector(".recipe-cooking-reviews__heading");
var reviewsContent = document.querySelector(".recipe-cooking-reviews__content"); // Reviews Delegation

if (reviewsButton) {
  reviewsButton.addEventListener("click", function () {
    return toggleReviews();
  });
}
...
var mainRecipeImage = document.querySelector(".recipe-masthead__image-fg");
var mainRecipeImageBG = document.querySelector(".recipe-masthead__image-bg");

if (mainRecipeImage) {
  if (mainRecipeImage.complete) {
    var color = colorThief.getColor(mainRecipeImage);
    mainRecipeImageBG.style.backgroundColor = "rgb(".concat(color[0], ", ").concat(color[1], ", ").concat(color[2], ")");
  } else {
